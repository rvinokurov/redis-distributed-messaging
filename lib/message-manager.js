...
module.exports = class MessageManager {
    ...
    message(message) {
        console.log(`receive message from ${message.node} :`, message.message)
        this.scope.publisher.publish(`${message.node}:recieved`, JSON.stringify({node: this.scope.nodeName}));
    }
